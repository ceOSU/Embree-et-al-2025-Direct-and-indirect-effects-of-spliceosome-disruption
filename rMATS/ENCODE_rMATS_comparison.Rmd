...
# Look at PE includion level

I am going to look at the inclusion levels of Poison exons (PE) compared to other cassette exons in the genome.
The list of cassette exons was downloaded from HexEvent on 8/7/2024.

```{r PE list}
Saltzman_transcripts <- read_csv("C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/Poison_Exons/Saltzman_inclusion_NMD_transcripts.csv")
all_cassette_exons <- read_delim("C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/Poison_Exons/all_cassette_exons.txt", 
    delim = "\t", escape_double = FALSE, 
    trim_ws = TRUE)
all_cassette_exons = all_cassette_exons %>% mutate(chromo = str_remove(chromo,"chr"))
```
