...
#C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/ENCODE_GNB2L1_HepG2 --> working directory of the project
...
setwd(dir = "C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/ENCODE_GNB2L1_HepG2")

#Load File containing sample types

samples <- read_excel("C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/ENCODE_GNB2L1_HepG2/samples.xlsx")

View(samples)

#Load in the files

files1 <- file.path("C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/ENCODE_GNB2L1_HepG2","koutput", samples$Run, "abundance.h5")
...
GNB2L1_HepG2transcripts=filter(listgenes, external_gene_name == "GNB2L1" )

GNB2L1_HepG2transcriptsWT<-GNB2L1_HepG2transcripts %>% dplyr::select(WT1,WT2, ensembl_transcript_id_version, external_gene_name, external_transcript_name)

GNB2L1_HepG2transcriptsWT$averagecounts = rowMeans(GNB2L1_HepG2transcriptsWT[,c("WT1","WT2")])

#put in specific library names above

GNB2L1_HepG2transcriptsWT$percent= GNB2L1_HepG2transcriptsWT$averagecounts/sum(GNB2L1_HepG2transcriptsWT$averagecounts)

GNB2L1_HepG2transcriptsWT<-GNB2L1_HepG2transcriptsWT %>% arrange(averagecounts)

#Repeat for the KD transcripts

GNB2L1_HepG2transcriptsKD<-GNB2L1_HepG2transcripts %>% dplyr::select(KD1,KD2, ensembl_transcript_id_version, external_gene_name, external_transcript_name)

GNB2L1_HepG2transcriptsKD$averagecounts = rowMeans(GNB2L1_HepG2transcriptsKD[,c("KD1","KD2")])

GNB2L1_HepG2transcriptsKD$percent= GNB2L1_HepG2transcriptsKD$averagecounts/sum(GNB2L1_HepG2transcriptsKD$averagecounts)

GNB2L1_HepG2transcriptsKD<-GNB2L1_HepG2transcriptsKD %>% arrange(averagecounts)
...
plot(euler(s), quantities = TRUE,
     main="GNB2L1 knockout vs control")
...
NMDBio_cdf = ggplot(alltransbioNMD, aes(log2FoldChange, colour=transcript_biotype))+
  ...
  labs(y = "Cumulative Frequency", title = "GNB2L1 KD vs WT", subtitle = "NMD biotype")
NMDBio_cdf

#### analysis with robert's PTC+ and PTC- list ####
ENST_PTC.EPI.TFG <- read.delim("C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/ENCODE_GNB2L1_HepG2/ENST_PTC-EPI-TFG.txt")
...
PTC_cdf = ggplot(alltransPTC, aes(log2FoldChange, colour=PTC.Status))+
  ...
  coord_cartesian(xlim = c(-3,3)) +
  scale_color_manual(values = met.brewer("Java",2)) +
  labs(y = "Cumulative Frequency", title = "GNB2L1 KD vs WT", subtitle = "PTC list")
PTC_cdf
...
NMD_transcripts = read.delim("C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/ENCODE_GNB2L1_HepG2/NMD_transcript_list.txt")
...
NMD_cdf = ggplot(alltransNMD, aes(log2FoldChange, colour=NMD))+
  ...
  coord_cartesian(xlim = c(-3,3)) +
  scale_color_manual(values = met.brewer("Java",2)) +
  labs(y = "Cumulative Frequency", title = "GNB2L1 KD vs WT", subtitle = "NMD +/- list")
NMD_cdf
...
StringentNMD = read.csv("C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/ENCODE_GNB2L1_HepG2/Stringent_NMD_list_CE")
...
sNMD_cdf = ggplot(alltransSTNMD, aes(log2FoldChange, colour=NMD))+
  ...
  coord_cartesian(xlim = c(-3,3)) +
  scale_color_manual(values = met.brewer("Java",2)) +
  labs(y = "Cumulative Frequency", title = "GNB2L1 KD vs WT", subtitle = "Stringent NMD list")
sNMD_cdf
...
sPTC = read.csv("C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/ENCODE_GNB2L1_HepG2/Stringent_PTC_CE") 
alltransSPTC = inner_join(alltrans, sPTC, by = c("ENST.ID" = "transID")) #683 PTC false 207 PTC true
sPTC_res <- wilcox.test(log2FoldChange ~ PTC, data = alltransSPTC,
                        exact = FALSE, alternative = "less")
head(alltransSPTC)
count(alltransSPTC, PTC) #683 PTC false 207 PTC true
sPTC_res #p-vlaue = 0.1418
...
sPTC_cdf = sPTC_cdf + annotate("text", x=-2.5,y=1, label = "GNB2L1 KD vs WT", size = 5, hjust = 0) +
  annotate("text", x=-2.5,y=.95, label = "Stringent PTC containing transcripts", hjust =0) +
  annotate("text", x=-2.5,y=.9, label = "p-value = 0.1418", hjust = 0) +
  annotate("text", x = -2.5, y = 0.85, label = "PTC+ = 207", hjust = 0) +
  annotate("text", x = -2.5, y = 0.8, label = "PTC- = 683", hjust = 0) +
  geom_vline(xintercept = 0, color = "grey") + 
  geom_hline(yintercept = 0.5, color = "grey") +
  theme(legend.position = c(0.85,0.1))
sPTC_cdf
ggsave("GNB2L1_HepG2_sPTC_CDF.pdf", 
       plot = sPTC_cdf,
       scale = 1,
       width = 8,
       height = 6,
       ...
       device = "pdf",
       dpi = 300)
ggsave("C:/Users/Caleb/OneDrive - The Ohio State University/Splicing and NMD/Figures/Data/GNB2L1_HepG2_sPTC_CDF.pdf", 
       plot = sPTC_cdf,
       scale = 1,
       width = 8,
       height = 6,
...
GNB2L1_x = alltransSTNMD %>% filter(NMD == "TRUE")  %>% #Makes a data table of the top NMD transcript for each gene
  select(Gene,log2FoldChange,baseMean) %>% 
  rename(plusFC = log2FoldChange) %>% 
  group_by(Gene) %>% 
  slice_max(baseMean, n = 1)

GNB2L1_y  = alltransSTNMD %>% filter(NMD == "FALSE")  %>% #Makes a data table fo the top NMD- transcript for each gene
  select(Gene,log2FoldChange,baseMean) %>% 
  rename(minusFC = log2FoldChange) %>% 
  group_by(Gene) %>% 
  slice_max(baseMean, n = 1)

GNB2L1_scatter = full_join(GNB2L1_x, GNB2L1_y, by = "Gene", suffix = c("plus","minus")) #Combine the two top tables
GNB2L1_scatter = GNB2L1_scatter %>% filter(!is.na(minusFC)) %>% 
  filter(!is.na(plusFC)) #Removes any NA rows


dot = ggplot(data = GNB2L1_scatter)+
  ...
  labs(x = "Log2FC NMD+", y = "Log2FC NMD-", title = "GNB2L1 gene-level FC comparison")+
  theme_minimal()+
...
GNB2L1_NMD = alltrans_MANE %>% inner_join(NMD_factors, by = c("external_gene_name" = "NMDfactor"))
write.csv(GNB2L1_NMD, "C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/NMD_analysis/GNB2L1_NMDfactor.csv",row.names = FALSE)
...
sPTC_MANE_res <- wilcox.test(log2FoldChange ~ PTC, data = alltransSPTC_MANE,
                             exact = FALSE, alternative = "less")
count(alltransSPTC_MANE, PTC) # 262 PTC false 207 PTC true
sPTC_MANE_res #p-vlaue = 0.5026
...
MANE_sPTC_cdf = ggplot(alltransSPTC_MANE, aes(log2FoldChange, colour=PTC))+
  ...
  scale_color_manual(values = plot_colors) +
  labs(y = "Cumulative Frequency")
MANE_sPTC_cdf = MANE_sPTC_cdf + annotate("text", x=-2.5,y=1, label = "GNB2L1 KD vs WT", size = 5, hjust = 0) +
  annotate("text", x=-2.5,y=.95, label = "PTC containing and MANE transcripts", hjust =0) +
  annotate("text", x=-2.5,y=.9, label = "p-value = 0.5206", hjust = 0) +
  annotate("text", x = -2.5, y = 0.85, label = "PTC+ = 207", hjust = 0) +
  annotate("text", x = -2.5, y = 0.8, label = "PTC- = 262", hjust = 0) +
  geom_vline(xintercept = 0, color = "grey") + 
  geom_hline(yintercept = 0.5, color = "grey") +
  theme(legend.position = c(0.85,0.1))
MANE_sPTC_cdf
ggsave("GNB2L1_HepG2_sPTC_MANE_CDF.pdf", 
       plot = MANE_sPTC_cdf,
       scale = 1,
       width = 8,
       height = 6,
       ...
       device = "pdf",
       dpi = 300)
ggsave("C:/Users/Caleb/OneDrive - The Ohio State University/Splicing and NMD/Figures/Data/GNB2L1_HepG2_sPTC_MANE_CDF.pdf", 
       plot = MANE_sPTC_cdf,
       scale = 1,
       width = 8,
       height = 6,
...
PEa_res <- wilcox.test(log2FoldChange ~ isoform, data = PEa_FC,
                       exact = FALSE, alternative = "less")
head(PEa_FC)
count(PEa_FC, isoform)# 272 PE 223  MANE
PEa_res #p-vlaue = 0.9999
...
PEa_cdf = ggplot(PEa_FC, aes(log2FoldChange, colour=isoform))+
  ...
  scale_color_manual(values = plot_colors) +
  labs(y = "Cumulative Frequency")
PEa_cdf = PEa_cdf + annotate("text", x=-2.5,y=1, label = "GNB2L1 KD vs WT", size = 5, hjust = 0) +
  annotate("text", x=-2.5,y=.95, label = "Transcripts with a poison exon", hjust =0) +
  annotate("text", x=-2.5,y=.9, label = "p-value = 0.9999", hjust = 0) +
  annotate("text", x = -2.5, y = 0.85, label = "PE = 272", hjust = 0) +
  annotate("text", x = -2.5, y = 0.8, label = "MANE = 223", hjust = 0) +
  geom_vline(xintercept = 0, color = "grey") + 
  geom_hline(yintercept = 0.5, color = "grey") +
  theme(legend.position = c(0.85,0.1))
PEa_cdf
ggsave("GNB2L1_HepG2_PE_archive_CDF.pdf", 
       plot = PEa_cdf,
       scale = 1,
       width = 8,
       height = 6,
       ...
       device = "pdf",
       dpi = 300)
ggsave("C:/Users/Caleb/OneDrive - The Ohio State University/Splicing and NMD/Figures/Data/GNB2L1_HepG2_PEarchive_CDF.pdf", 
       plot = PEa_cdf,
       scale = 1,
       width = 8,
       height = 6,
...
GNB2L1_SC_impact = alltrans_MANE %>% inner_join(Splicing_factors, by = c("external_gene_name" = "Component"))
write.csv(GNB2L1_SC_impact, "GNB2L1_splicing_impact.csv",row.names = FALSE)

#### Pull the TPM of genes for the NMD TPM graph ####
full_tpm = listgenes %>% rowwise() %>%  mutate(KDmean = mean(c_across(1:2)), WTmean = mean(c_across(3:4))) %>% ungroup()
...
write_csv(PTC_tpm, "GNB2L1_PTC_MANE_TPM.csv")
write_csv(PTC_tpm, "C:/Users/Caleb/OneDrive - The Ohio State University/Splicing and NMD/Figures/Data/NMD_TPM/GNB2L1_PTC_MANE_TPM.csv")
...
write_csv(WTalltrans,"C:/Users/Caleb/OneDrive - The Ohio State University/Splicing and NMD/Figures/Data/NMD_TPM/GNB2L1_WTfilt_alltrans.csv")
write_csv(alltrans,"C:/Users/Caleb/OneDrive - The Ohio State University/Splicing and NMD/Figures/Data/NMD_TPM/GNB2L1_DBfilt_alltrans.csv")
write_csv(alltransSPTC_MANE,"C:/Users/Caleb/OneDrive - The Ohio State University/Splicing and NMD/Figures/Data/NMD_TPM/GNB2L1_PTC_alltrans.csv")
...
write_csv(WT5alltrans,"C:/Users/Caleb/OneDrive - The Ohio State University/Splicing and NMD/Figures/Data/NMD_TPM/GNB2L1_WT5filt_alltrans.csv")
