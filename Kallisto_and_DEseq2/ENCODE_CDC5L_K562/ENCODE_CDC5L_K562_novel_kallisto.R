...
#Analyzing: CDC5L Kallisto results from transcriptome including novel transcripts
...
# C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/ENCODE_CDC5L_K562/novel_kallisto --> working directory of the project
...
# CDC5L --> Ensemble name of your gene of interest
...
#### Load in the files ####
files1 <- file.path("C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/ENCODE_CDC5L_K562/novel_kallisto","novel_koutput", samples$Run, "abundance.h5")
...
alltrans_novel = alltrans %>% filter(str_detect(ENST.ID,"MST")) %>% 
  left_join(CDC5L_novel_iso_features,by = c("ENST.ID" = "isoform_id"))#add in the annotation from ISAR for the novel isoforms
...
write_csv(alltransbio,"C:/Users/Caleb/OneDrive - The Ohio State University/Splicing and NMD/Figures/Data/NMD_TPM/CDC5L_NK_alltrans.csv")
...
write.csv(CDC5L_NMD, "C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/NMD_analysis/CDC5L_nk_NMDfactor.csv",row.names = FALSE)
...
CDC5L_SC_impact = alltrans_MANE %>% inner_join(Splicing_factors, by = c("external_gene_name" = "Component"))
write.csv(CDC5L_SC_impact, "CDC5L_splicing_impact.csv",row.names = FALSE)
