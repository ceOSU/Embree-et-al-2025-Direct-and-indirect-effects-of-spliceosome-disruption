...
#Analyzing: SF3B3 Kallisto results from transcriptome including novel transcripts
...
# C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/ENCODE_SF3B3_K562/novel_kallisto --> working directory of the project
# SRR22520907 --> Sample ID of first KD sample
# SRR22520908 --> Sample ID of second KD sample
# SRR22522157 --> Sample ID of first WT sample
# SRR22522158 --> Sample ID of second WT sample
# SF3B3 --> Ensemble name of your gene of interest
...
#### Load in the files ####
files1 <- file.path("C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/ENCODE_SF3B3_K562/novel_kallisto","novel_koutput", samples$Run, "abundance.h5")
names(files1) <- paste0(c("SRR22522157","SRR22522158","SRR22520907","SRR22520908"))
files1
...
counts = counts %>% mutate(kdMean = rowMeans(dplyr::select(counts,c(SRR22520907,SRR22520908)), na.rm = TRUE) ,
                           wtMean = rowMeans(dplyr::select(counts,c(SRR22522157,SRR22522158)), na.rm = TRUE)) %>% 
...
SF3B3_novel_iso_features <- read_csv("C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/ENCODE_SF3B3_ISAR/SF3B3_novel_iso_features.csv")
novel_genes = counts %>% filter(str_detect(ENSTID,"MST")) %>% 
  full_join(SF3B3_novel_iso_features, by = c("ENSTID" = "isoform_id"))
full_genelist = anno_genes %>% full_join(novel_genes, by = c("ENSTID",
                                                             "ensembl_gene_id" = "gene_id",
                                                             "external_gene_name" = "gene_name",
                                                             "SRR22522157","SRR22522158","SRR22520907","SRR22520908",
...
alltrans_novel = alltrans %>% filter(str_detect(ENST.ID,"MST")) %>% 
  left_join(SF3B3_novel_iso_features,by = c("ENST.ID" = "isoform_id"))#add in the annotation from ISAR for the novel isoforms
...
write_csv(alltransbio,"C:/Users/Caleb/OneDrive - The Ohio State University/Splicing and NMD/Figures/Data/NMD_TPM/SF3B3_NK_alltrans.csv")
...
write.csv(SF3B3_NMD, "C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/NMD_analysis/SF3B3_nk_NMDfactor.csv",row.names = FALSE)
...
write_csv(PTC_tpm, "C:/Users/Caleb/OneDrive - The Ohio State University/Splicing and NMD/Figures/Data/NMD_TPM/SF3B3_nk_PTC_MANE_TPM.csv")
