...
#Analyzing: SNRPC Kallisto results from transcriptome including novel transcripts
...
# C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/ENCODE_SNRPC_K562_KO/novel_kallisto --> working directory of the project
...
getwd()
samples <- read_excel("C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/ENCODE_SNRPC_K562_KO/SNRPC_K562_samples.xlsx")
View(samples)


#### Load in the files ####
files1 <- file.path("C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/ENCODE_SNRPC_K562_KO/novel_kallisto","novel_koutput", samples$Run, "abundance.h5")
...
SNRPC_novel_iso_features <- read_csv("C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/ENCODE_SNRPC_ISAR/SNRPC_novel_iso_features.csv")
novel_genes = counts %>% filter(str_detect(ENSTID,"MST")) %>% 
  full_join(SNRPC_novel_iso_features, by = c("ENSTID" = "isoform_id"))
...
alltrans_novel = alltrans %>% filter(str_detect(ENST.ID,"MST")) %>% 
  left_join(SNRPC_novel_iso_features,by = c("ENST.ID" = "isoform_id"))#add in the annotation from ISAR for the novel isoforms
...
write_csv(alltransbio,"C:/Users/Caleb/OneDrive - The Ohio State University/Splicing and NMD/Figures/Data/NMD_TPM/SNRPC_NK_alltrans.csv")
...
write.csv(SNRPC_NMD, "C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/NMD_analysis/SNRPC_nk_NMDfactor.csv",row.names = FALSE)
...
SNRPC_SC_impact = alltrans_MANE %>% inner_join(Splicing_factors, by = c("external_gene_name" = "Component"))
write.csv(SNRPC_SC_impact, "SNRPC_splicing_impact.csv",row.names = FALSE)
...
write_csv(PTC_tpm, "C:/Users/Caleb/OneDrive - The Ohio State University/Splicing and NMD/Figures/Data/NMD_TPM/SNRPC_nk_PTC_MANE_TPM.csv")
