...
#Analyzing: EIF4A3 Kallisto results from transcriptome including novel transcripts
...
# C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/ENCODE_EIF4A3_K562/novel_kallisto --> working directory of the project
# SRR3469594 --> Sample ID of first WT sample
# SRR3469595 --> Sample ID of second WT sample
# SRR3469574 --> Sample ID of first KD sample
# SRR3469575 --> Sample ID of second KD sample
...
getwd()
samples <- read_excel("C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/ENCODE_EIF4A3_K562/ENCODE_EIF4A3_K562_samples.xlsx")
View(samples)


#### Load in the files ####
files1 <- file.path("C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/ENCODE_EIF4A3_K562/novel_kallisto","novel_koutput", samples$Run, "abundance.h5")
...
counts = counts %>% mutate(kdMean = rowMeans(dplyr::select(counts,c(SRR3469594,SRR3469595)), na.rm = TRUE) ,
                           wtMean = rowMeans(dplyr::select(counts,c(SRR3469574,SRR3469575)), na.rm = TRUE)) %>% 
...
EIF4A3_novel_iso_features <- read_csv("C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/ENCODE_EIF4A3_ISAR/EIF4A3_novel_iso_features.csv")
novel_genes = counts %>% filter(str_detect(ENSTID,"MST")) %>% 
  full_join(EIF4A3_novel_iso_features, by = c("ENSTID" = "isoform_id"))
full_genelist = anno_genes %>% full_join(novel_genes, by = c("ENSTID",
                                                             "ensembl_gene_id" = "gene_id",
                                                             "external_gene_name" = "gene_name",
                                                             "SRR3469574","SRR3469575","SRR3469594","SRR3469595",
...
alltrans_novel = alltrans %>% filter(str_detect(ENST.ID,"MST")) %>% 
  left_join(EIF4A3_novel_iso_features,by = c("ENST.ID" = "isoform_id"))#add in the annotation from ISAR for the novel isoforms
...
write_csv(alltransbio,"C:/Users/Caleb/OneDrive - The Ohio State University/Splicing and NMD/Figures/Data/NMD_TPM/EIF4A3_NK_alltrans.csv")
...
write.csv(EIF4A3_NMD, "C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/NMD_analysis/EIF4A3_nk_NMDfactor.csv",row.names = FALSE)
...
write_csv(PTC_tpm, "C:/Users/Caleb/OneDrive - The Ohio State University/Splicing and NMD/Figures/Data/NMD_TPM/EIF4A3_nk_PTC_MANE_TPM.csv")
