...
#Analyzing: Gene Level analysis of SNRNP200 KD
...
# C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/ENCODE_SNRNP200_K562 --> working directory of the project
...
PCA
ggsave("SNRNP200_geneLevel_PCA.pdf",
       plot = PCA,
       device = pdf,
       width = 5,
       height = 5,
...
GL_NMD_box = GL_NMD_box + geom_boxplot(aes(x = NMD,
  ...
  labs(y = "log2(Fold Change)",
       ...
       title = "SNRNP200 KD Gene Level Analysis")+
  coord_cartesian(y = c(-4,4)) +
  theme_bw()
GL_NMD_box
ggsave("SNRNP200_geneLevel_NMD.pdf",
       plot = GL_NMD_box,
       device = pdf,
       width = 10,
       height = 10,
