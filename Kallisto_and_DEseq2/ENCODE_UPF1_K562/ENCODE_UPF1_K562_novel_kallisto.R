...
#Analyzing: UPF1 Kallisto results from transcriptome including novel transcripts
...
# C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/ENCODE_UPF1_K562/novel_kallisto --> working directory of the project
# SRR4421542 --> Sample ID of first WT sample
# SRR4421543 --> Sample ID of second WT sample
# SRR4421434 --> Sample ID of first KD sample
# SRR4421435 --> Sample ID of second KD sample
...
getwd()
samples <- read_excel("C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/ENCODE_UPF1_K562/UPF1_K562_samples.xlsx")
View(samples)


#### Load in the files ####
files1 <- file.path("C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/ENCODE_UPF1_K562/novel_kallisto","novel_koutput", samples$Run, "abundance.h5")
...
counts = counts %>% mutate(kdMean = rowMeans(dplyr::select(counts,c(SRR4421542,SRR4421543)), na.rm = TRUE) ,
                           wtMean = rowMeans(dplyr::select(counts,c(SRR4421434,SRR4421435)), na.rm = TRUE)) %>% 
...
UPF1_novel_iso_features <- read_csv("C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/ENCODE_UPF1_ISAR/UPF1_novel_iso_features.csv")
novel_genes = counts %>% filter(str_detect(ENSTID,"MST")) %>% 
  full_join(UPF1_novel_iso_features, by = c("ENSTID" = "isoform_id"))
full_genelist = anno_genes %>% full_join(novel_genes, by = c("ENSTID",
                                                             "ensembl_gene_id" = "gene_id",
                                                             "external_gene_name" = "gene_name",
                                                             "SRR4421434","SRR4421435","SRR4421542","SRR4421543",
...
alltrans_novel = alltrans %>% filter(str_detect(ENST.ID,"MST")) %>% 
  left_join(UPF1_novel_iso_features,by = c("ENST.ID" = "isoform_id"))#add in the annotation from ISAR for the novel isoforms
...
write_csv(alltransbio,"C:/Users/Caleb/OneDrive - The Ohio State University/Splicing and NMD/Figures/Data/NMD_TPM/UPF1_NK_alltrans.csv")
...
write.csv(UPF1_NMD, "C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/NMD_analysis/UPF1_nk_NMDfactor.csv",row.names = FALSE)
...
write_csv(PTC_tpm, "C:/Users/Caleb/OneDrive - The Ohio State University/Splicing and NMD/Figures/Data/NMD_TPM/UPF1_nk_PTC_MANE_TPM.csv")
