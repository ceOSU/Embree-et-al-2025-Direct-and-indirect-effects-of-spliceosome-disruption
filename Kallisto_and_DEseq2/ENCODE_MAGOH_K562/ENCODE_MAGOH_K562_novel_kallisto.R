...
#Analyzing: MAGOH Kallisto results from transcriptome including novel transcripts
...
# C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/ENCODE_MAGOH_K562/novel_kallisto --> working directory of the project
# SRR3469568 --> Sample ID of first WT sample
# SRR3469569 --> Sample ID of second WT sample
# SRR3469418 --> Sample ID of first KD sample
# SRR3469419 --> Sample ID of second KD sample
# MAGOH --> Ensemble name of your gene of interest
...
#### Load in the files ####
files1 <- file.path("C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/ENCODE_MAGOH_K562/novel_kallisto","novel_koutput", samples$Run, "abundance.h5")
names(files1) <- paste0(c("SRR3469418","SRR3469419","SRR3469568","SRR3469569"))
files1
...
counts = counts %>% mutate(kdMean = rowMeans(dplyr::select(counts,c(SRR3469568,SRR3469569)), na.rm = TRUE) ,
                           wtMean = rowMeans(dplyr::select(counts,c(SRR3469418,SRR3469419)), na.rm = TRUE)) %>% 
...
MAGOH_novel_iso_features <- read_csv("C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/ENCODE_MAGOH_ISAR/MAGOH_novel_iso_features.csv")
novel_genes = counts %>% filter(str_detect(ENSTID,"MST")) %>% 
  full_join(MAGOH_novel_iso_features, by = c("ENSTID" = "isoform_id"))
full_genelist = anno_genes %>% full_join(novel_genes, by = c("ENSTID",
                                                             "ensembl_gene_id" = "gene_id",
                                                             "external_gene_name" = "gene_name",
                                                             "SRR3469418","SRR3469419","SRR3469568","SRR3469569",
...
alltrans_novel = alltrans %>% filter(str_detect(ENST.ID,"MST")) %>% 
  left_join(MAGOH_novel_iso_features,by = c("ENST.ID" = "isoform_id"))#add in the annotation from ISAR for the novel isoforms
...
write_csv(alltransbio,"C:/Users/Caleb/OneDrive - The Ohio State University/Splicing and NMD/Figures/Data/NMD_TPM/MAGOH_NK_alltrans.csv")
...
write.csv(MAGOH_NMD, "C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/NMD_analysis/MAGOH_nk_NMDfactor.csv",row.names = FALSE)
...
write_csv(PTC_tpm, "C:/Users/Caleb/OneDrive - The Ohio State University/Splicing and NMD/Figures/Data/NMD_TPM/MAGOH_nk_PTC_MANE_TPM.csv")
