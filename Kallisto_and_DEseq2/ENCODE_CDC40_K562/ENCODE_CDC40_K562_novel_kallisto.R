...
#Analyzing: CDC40 Kallisto results from transcriptome including novel transcripts
...
# C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/ENCODE_CDC40_K562/novel_kallisto --> working directory of the project
# SRR14839335 --> Sample ID of first WT sample
# SRR14839336 --> Sample ID of second WT sample
# SRR14848422 --> Sample ID of first KD sample
# SRR14848423 --> Sample ID of second KD sample
# CDC40 --> Ensemble name of your gene of interest
...
#### Load in the files ####
files1 <- file.path("C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/ENCODE_CDC40_K562/novel_kallisto","novel_koutput", samples$Run, "abundance.h5")
names(files1) <- paste0(c("SRR14848422","SRR14848423","SRR14839335","SRR14839336"))
files1
...
counts = counts %>% mutate(kdMean = rowMeans(dplyr::select(counts,c(SRR14839335,SRR14839336)), na.rm = TRUE) ,
                           wtMean = rowMeans(dplyr::select(counts,c(SRR14848422,SRR14848423)), na.rm = TRUE)) %>% 
...
CDC40_novel_iso_features <- read_csv("C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/ENCODE_CDC40_ISAR/CDC40_novel_iso_features.csv")
novel_genes = counts %>% filter(str_detect(ENSTID,"MST")) %>% 
  full_join(CDC40_novel_iso_features, by = c("ENSTID" = "isoform_id"))
full_genelist = anno_genes %>% full_join(novel_genes, by = c("ENSTID",
                                                             "ensembl_gene_id" = "gene_id",
                                                             "external_gene_name" = "gene_name",
                                                             "SRR14848422","SRR14848423","SRR14839335","SRR14839336",
...
alltrans_novel = alltrans %>% filter(str_detect(ENST.ID,"MST")) %>% 
  left_join(CDC40_novel_iso_features,by = c("ENST.ID" = "isoform_id"))#add in the annotation from ISAR for the novel isoforms
...
write_csv(alltransbio,"C:/Users/Caleb/OneDrive - The Ohio State University/Splicing and NMD/Figures/Data/NMD_TPM/CDC40_NK_alltrans.csv")
...
write.csv(CDC40_NMD, "C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/NMD_analysis/CDC40_nk_NMDfactor.csv",row.names = FALSE)
...
CDC40_SC_impact = alltrans_MANE %>% inner_join(Splicing_factors, by = c("external_gene_name" = "Component"))
write.csv(CDC40_SC_impact, "CDC40_splicing_impact.csv",row.names = FALSE)
...
write_csv(PTC_tpm, "C:/Users/Caleb/OneDrive - The Ohio State University/Splicing and NMD/Figures/Data/NMD_TPM/CDC40_nk_PTC_MANE_TPM.csv")
