...
# Analyzing: KD of PRPF8 from ENCODE
...
#### Copy and Paste ####
#PRPF8 = Gene of Interest
#C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/ENCODE_PRPF8_ISAR = Path to the working directory
#SRR14848422 = First WT sample
#SRR14848423 = Second WT sample
#SRR14842475 = First KD sample
#SRR14842476 = Second KD sample
...
library(tidyverse)
library(biomaRt)
setwd("C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/ENCODE_PRPF8_ISAR")

####Import datasets####
PRPF8quant = importIsoformExpression(parentDir = "C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/ENCODE_PRPF8_ISAR",
                                   addIsofomIdAsColumn = TRUE, 
                                   showProgress = TRUE,
                                   readLength = 100
) #reads the t_data.ctab file in each sub directory
names(PRPF8quant)
tail(PRPF8quant$abundance)
tail(PRPF8quant$counts)

#Generate the list of isoform switches
myDesign = data.frame(sampleID = c("SRR14848422","SRR14848423","SRR14842475","SRR14842476"),
                      condition = c("WT","WT","KD","KD"))
comparisons = data.frame(condition_1 = "WT",
                         condition_2 = "KD")
SwitchList = importRdata(isoformCountMatrix = PRPF8quant$counts,
                         isoformRepExpression = PRPF8quant$abundance,
                         designMatrix = myDesign,
                         isoformExonAnnoation = "C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/ENCODE_PRPF8_ISAR/st_merged.gtf",
                         isoformNtFasta = "C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/ENCODE_PRPF8_ISAR/PRPF8_transcripts.fa",
                         showProgress = TRUE,
...
all_novel_tpm_filt = all_novel_tpm_filt %>% dplyr::select(3:12,18:19) %>% mutate(sample = "PRPF8")
write_csv(all_novel_tpm_filt, "C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/Combined_analysis/PRPF8_novel_TPM.csv")
...
ggsave("PRPF8_ISAR_lengths.pdf",
       ...
       device = pdf,
       dpi = 300)
write_csv(switching_ORF, "C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/Combined_analysis/PRPF8_switch_ORF_length.csv")