...
# Analyzing: SF3A3 shRNA KD from ENCODE
...
#### Copy and Paste ####
#SF3A3 = Gene of Interest
#C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/SF3A3_ISAR = Path to the working directory
#SRR4421434 = First WT sample
#SRR4421435 = Second WT sample
#SRR4421814 = First KD sample
#SRR4421815 = Second KD sample
...
library(rhdf5)
library(dplyr)
setwd("C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/SF3A3_ISAR")

#Import datasets
SF3A3quant = importIsoformExpression(parentDir = "C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/SF3A3_ISAR",
                                      addIsofomIdAsColumn = TRUE, 
                                      showProgress = TRUE,
                                      readLength = 100
) #reads the t_data.ctab file in each sub directory
names(SF3A3quant)
tail(SF3A3quant$abundance)
tail(SF3A3quant$counts)

#Generate the list of isoform switches
myDesign = data.frame(sampleID = c("SRR4421434","SRR4421435","SRR4421814","SRR4421815"),
                      condition = c("WT","WT","KD","KD"))
SwitchList = importRdata(isoformCountMatrix = SF3A3quant$counts,
                         isoformRepExpression = SF3A3quant$abundance,
                         designMatrix = myDesign,
                         isoformExonAnnoation = "C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/SF3A3_ISAR/st_merged.gtf",
                         isoformNtFasta = "C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/SF3A3_ISAR/SF3A3_transcripts.fa",
                         showProgress = TRUE)
...
SF3A3_TPM = PTC_TPM %>% full_join(Novel_TPM) %>% full_join(PTC_MANE_TPM)
write_csv(SF3A3_TPM, "C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/Combined_analysis/SF3A3_TPM.csv")
...
all_novel_tpm_filt = all_novel_tpm_filt %>% dplyr::select(3:12,18:19) %>% mutate(sample = "SF3A3")
write_csv(all_novel_tpm_filt, "C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/Combined_analysis/SF3A3_novel_TPM.csv")
...
ggsave("SF3A3_ISAR_lengths.pdf",
       ...
       device = pdf,
       dpi = 300)
write_csv(switching_ORF, "C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/Combined_analysis/SF3A3_switch_ORF_length.csv")