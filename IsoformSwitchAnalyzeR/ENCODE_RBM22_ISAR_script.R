...
# Analyzing: ENCODE RBM22 KD in K562 cells
...
#### Copy and Paste ####
#RBM22 = Gene of Interest
#C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/RBM22_ISAR = Path to the working directory
#SRR3469418 = First WT sample
#SRR3469419 = Second WT sample
#SRR3469592 = First KD sample
#SRR3469593 = Second KD sample
...
library(rhdf5)
library(dplyr)
setwd("C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/RBM22_ISAR")

#Import datasets
RBM22quant = importIsoformExpression(parentDir = "C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/RBM22_ISAR",
                                      addIsofomIdAsColumn = TRUE, 
                                      showProgress = TRUE,
                                      readLength = 100
) #reads the t_data.ctab file in each sub directory
names(RBM22quant)
tail(RBM22quant$abundance)
tail(RBM22quant$counts)

#Generate the list of isoform switches
myDesign = data.frame(sampleID = c("SRR3469418","SRR3469419","SRR3469592","SRR3469593"),
                      condition = c("WT","WT","KD","KD"))
SwitchList = importRdata(isoformCountMatrix = RBM22quant$counts,
                         isoformRepExpression = RBM22quant$abundance,
                         designMatrix = myDesign,
                         isoformExonAnnoation = "C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/RBM22_ISAR/st_merged.gtf",
                         isoformNtFasta = "C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/RBM22_ISAR/RBM22_transcripts.fa",
                         showProgress = TRUE)
...
RBM22_TPM = PTC_TPM %>% full_join(Novel_TPM) %>% full_join(PTC_MANE_TPM)
write_csv(RBM22_TPM, "C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/Combined_analysis/RBM22_TPM.csv")
...
all_novel_tpm = all_novel_tpm %>% mutate(kdTPM = rowMeans(dplyr::select(all_novel_tpm, 15:16), na.rm = TRUE))#X transcripts
all_novel_tpm_filt = all_novel %>% inner_join(filtTPM, by = "isoform_id")#X transcripts
all_novel_tpm_filt = all_novel_tpm_filt %>% dplyr::select(3:12,18:19) %>% mutate(sample = "RBM22")
write_csv(all_novel_tpm_filt, "C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/Combined_analysis/RBM22_novel_TPM.csv")
...
ggsave("RBM22_ISAR_lengths.pdf",
       ...
       device = pdf,
       dpi = 300)
write_csv(switching_ORF, "C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/Combined_analysis/RBM22_switch_ORF_length.csv")