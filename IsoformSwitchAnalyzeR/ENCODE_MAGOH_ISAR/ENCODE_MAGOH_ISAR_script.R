...
library(rhdf5)
library(dplyr)
setwd("C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/MAGOH_ISAR")

#Import datasets
MAGOHquant = importIsoformExpression(parentDir = "C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/MAGOH_ISAR",
...
SwitchList = importRdata(isoformCountMatrix = MAGOHquant$counts,
                         ...
                         isoformExonAnnoation = "C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/MAGOH_ISAR/st_merged.gtf",
                         isoformNtFasta = "C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/MAGOH_ISAR/MAGOH_transcripts.fa",
                         showProgress = TRUE)
...
) #The filtering removed 68730 ( 47.08% of ) transcripts. There is now 77253 isoforms left
