...
# Modified on: 
# Analyzing: MAGOH KD from ENCODE
...
#### Copy and Paste ####
#MAGOH = Gene of Interest
#C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/MAGOH_ISAR = Path to the working directory
#SRR3469418 = First WT sample
#SRR3469419 = Second WT sample
#SRR3469568 = First KD sample
#SRR3469569 = Second KD sample
...
library(tidyverse)
library(biomaRt)
setwd("C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/ENCODE_MAGOH_ISAR")

####Import datasets####
MAGOHquant = importIsoformExpression(parentDir = "C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/ENCODE_MAGOH_ISAR",
                                   addIsofomIdAsColumn = TRUE, 
                                   showProgress = TRUE,
                                   readLength = 100
) #reads the t_data.ctab file in each sub directory
names(MAGOHquant)
tail(MAGOHquant$abundance)
tail(MAGOHquant$counts)

#Generate the list of isoform switches
myDesign = data.frame(sampleID = c("SRR3469418","SRR3469419","SRR3469568","SRR3469569"),
                      condition = c("WT","WT","KD","KD"))
comparisons = data.frame(condition_1 = "WT",
                         condition_2 = "KD")
SwitchList = importRdata(isoformCountMatrix = MAGOHquant$counts,
                         isoformRepExpression = MAGOHquant$abundance,
                         designMatrix = myDesign,
                         isoformExonAnnoation = "C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/ENCODE_MAGOH_ISAR/st_merged.gtf",
                         isoformNtFasta = "C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/ENCODE_MAGOH_ISAR/MAGOH_transcripts.fa",
                         showProgress = TRUE,
...
PTC_MANE_TPM = PTC_MANE_TPM %>% dplyr::select(1:11,14) %>%
  mutate(type = "MANE")
MAGOH_TPM = PTC_TPM %>% full_join(Novel_TPM) %>% full_join(PTC_MANE_TPM)
write_csv(MAGOH_TPM, "C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/Combined_analysis/MAGOH_TPM.csv")
...
all_novel_tpm_filt = all_novel_tpm_filt %>% dplyr::select(3:12,18:19) %>% mutate(sample = "MAGOH")
write_csv(all_novel_tpm_filt, "C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/Combined_analysis/MAGOH_novel_TPM.csv")
...
ggsave("MAGOH_ISAR_lengths.pdf",
       ...
       device = pdf,
       dpi = 300)
write_csv(switching_ORF, "C:/Users/Caleb/OneDrive - The Ohio State University/BioinfoData/IsoformSwitch/Combined_analysis/MAGOH_switch_ORF_length.csv")